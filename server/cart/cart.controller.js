              ...
              [
                function(callback) {
                  if (req.body.customExpiryDate == true) {
                    Price.findOne({ name: "customExpiryDate" }, function(
                      err,
                      price
                    ) {
                      if (err) {
                        ...
                        Url.findById(id, function(err, x) {
                          if (err) {
                            ...
                            x.features.customExpiryDate.expiryDate = x.features
                              .customExpiryDate.expiryDate
                              ? moment(
                                  x.features.customExpiryDate.expiryDate
                                ).add(1, "year")
                              : moment().add(1, "year");
                            x.features.customExpiryDate.boughtPrice =
                              price.price;
                            x.features.customExpiryDate.currentPrice =
                              price._id;
                            x.features.customExpiryDate.puchaseDate = moment();
                            x.features.customExpiryDate.totalSpent +=
                              price.price;
                            ...
                            callback(
                              null,
                              "customExpiryDate is either already unlocked or you don't have sufficient amount in your wallet"
                            );
                          }
                        });
                      } else {
                ...
                function(callback) {
                  if (req.body.urlRedirectto == true) {
                    Price.findOne({ name: "urlRedirectto" }, function(
                      err,
                      price
                    ) {
                      if (err) {
                        ...
                        Url.findById(id, function(err, x) {
                          if (err) {
                            ...
                            x.features.urlRedirectto.expiryDate = x.features
                              .urlRedirectto.expiryDate
                              ? moment(x.features.urlRedirectto.expiryDate).add(
                                  1,
                                  "year"
                                )
                              : moment().add(1, "year");
                            ...
                            callback(
                              null,
                              "urlRedirectto is either already unlocked or you don't have sufficient amount in your wallet"
                            );
                          }
                        });
                      } else {
                ...
                function(callback) {
                  if (req.body.enableToggle == true) {
                    Price.findOne({ name: "enableToggle" }, function(
                      err,
                      price
                    ) {
                      if (err) {
                        ...
                        Url.findById(id, function(err, x) {
                          if (err) {
                            ...
                            x.features.enableToggle.expiryDate = x.features
                              .enableToggle.expiryDate
                              ? moment(x.features.enableToggle.expiryDate).add(
                                  1,
                                  "year"
                                )
                              : moment().add(1, "year");
                            ...
                            callback(
                              null,
                              "enableToggle is either already unlocked or you don't have sufficient amount in your wallet"
                            );
                          }
                        });
                      } else {
                      ...
                      if (err) {
                        ...
                        Url.findById(id, function(err, x) {
                          if (err) {
                            ...
                            x.features.blockIps.expiryDate = x.features.blockIps
                              .expiryDate
                              ? moment(x.features.blockIps.expiryDate).add(
                                  1,
                                  "year"
                                )
                              : moment().add(1, "year");
                            ...
                            callback(
                              null,
                              "blockIps is either already unlocked or you don't have sufficient amount in your wallet"
                            );
                          }
                        });
                      } else {
                ...
                function(callback) {
                  if (req.body.customReports == true) {
                    Price.findOne({ name: "customReports" }, function(
                      err,
                      price
                    ) {
                      if (err) {
                        ...
                        Url.findById(id, function(err, x) {
                          if (err) {
                            ...
                            x.features.customReports.expiryDate = x.features
                              .customReports.expiryDate
                              ? moment(x.features.customReports.expiryDate).add(
                                  1,
                                  "year"
                                )
                              : moment().add(1, "year");
                            ...
                            callback(
                              null,
                              "customReports is either already unlocked or you don't have sufficient amount in your wallet"
                            );
                          }
                        });
                      } else {
                      ...
                      if (err) {
                        ...
                        Url.findById(id, function(err, x) {
                          if (err) {
                            ...
                            x.features.fourOfour.expiryDate = x.features
                              .fourOfour.expiryDate
                              ? moment(x.features.fourOfour.expiryDate).add(
                                  1,
                                  "year"
                                )
                              : moment().add(1, "year");
                            ...
                            callback(
                              null,
                              "fourOfour is either already unlocked or you don't have sufficient amount in your wallet"
                            );
                          }
                        });
                      } else {
                ...
                function(callback) {
                  if (req.body.customShortUrl == true) {
                    Price.findOne({ name: "customShortUrl" }, function(
                      err,
                      price
                    ) {
                      if (err) {
                        ...
                        Url.findById(id, function(err, x) {
                          if (err) {
                            ...
                            x.features.customShortUrl.expiryDate = x.features
                              .customShortUrl.expiryDate
                              ? moment(
                                  x.features.customShortUrl.expiryDate
                                ).add(1, "year")
                              : moment().add(1, "year");
                            ...
                            callback(
                              null,
                              "customShortUrl is either already unlocked or you don't have sufficient amount in your wallet"
                            );
                          }
                        });
                      } else {
                ...
                if (err) {
                  ...
                  if (user.wallet < total) {
                    ...
                    User.findByIdAndUpdate(
                      req.userId,
                      { $inc: { wallet: -total, totalAmountSpent: total } },
                      { new: true }
                    )
                      .lean()
